...
export class GameState {
  ...
  @RecordType(StringType(), globalThis.String)
...
export class Inventory {
  @OptionalType(ArrayType(RecordType(StringType(), globalThis.Number)))
