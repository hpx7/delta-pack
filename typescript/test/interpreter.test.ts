...
import { Infer, load, equalsFloat, equalsFloatQuantized } from "@hpx7/delta-pack";
...
const Velocity = load<Velocity>(schema, "Velocity");
const Entity = load<Entity>(schema, "Entity");
...
describe("Delta Pack Interpreter - Unified API", () => {
  ...
  describe("Velocity Type - Non-Quantized Floats", () => {
    it("should parse correct velocity data", () => {
      const vel: Velocity = { vx: 123.456789, vy: 78.912345 };
